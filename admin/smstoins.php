...
<!-- Horizontal Form -->
              <div class="box box-primary" style="width:60%;position:center;margin:0 auto;">
                ...
                <div class="box-header with-border">
                  <p class="box-title">Send SMS of Complaint No.#: <em><strong><?php echo $RpID; ?></strong></em>
            ...
            <!--<h4><?php echo $qrExF['ward_no']; ?></h4> &amp; <h3><?php  echo $qrExF['addresss'];?></h3>-->
                ...
                <!-- form start -->
                <form class="form-horizontal" action="smstoinsproc.php" method="post" enctype="multipart/form-data" >
                  <div class="box-body">
