    ...
    <div id="main" role="main" class="row">
      <div id="content" class="span8">
        <div class="content-head">
          ...
          <div style="float:right;" class="fb-share-button" data-href="http://dncc.citizenconnect.org/reportview.php?reportID=<?php echo $rpqueryresFet['report_id'];?>" data-layout="box_count" data-mobile-iframe="true" ></div>
        </div>
          </h2>
...
<div class="container-fluid">
	...
	<p>
		...
		<!--	<p>
				<strong> Specific Location:-->
        
     <!--  </strong> <strong>Map Location Address:--><!--</strong>
			</p>-->
	...
	<div class="tabbable">
		...
		<li class="active">
	  	<a href="#location-tab" data-toggle="tab">Location</a>
      </li>
...
<br/>
<p><strong>Map Location:<?php echo $rpqueryresFet['map_addr'];?> </strong> </p>
  <!--<p><strong>coordinates x,y: </strong>  </p>-->
  <p><strong>coordinates lat,lng: </strong> <a href="https://www.google.com/maps/place/<?php echo $rpqueryresFet['map_lat'];?>,<?php echo $rpqueryresFet['map_lng'];?>" target="_blank"><?php echo $rpqueryresFet['map_lat'];?>,<?php echo $rpqueryresFet['map_lng'];?></a></p>
